...
<style type="text/css">
	*{
	...
	ul li .active{
		background-image: url(./img/粉色横杠.png);
		font-weight: bold;
	}	
...
<body>
	...
	<div class="container-fluid" style="margin-bottom: 2%">
		...
		<div class="row" style="margin-top:2px;">
			...
			<img  style="margin-left:5%;" src="./img/男.png"  id="gender">
			<span style="color: rgb(61,50,53)">编辑资料</span>
		</div>
	
		
		<div id="intro">
			<div class="col-md-4 col-md-offset-4 col-xs-6 col-xs-offset-2 row">
				<p style="text-align: left!important">个人介绍：xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx</p>
			</div>
			<div class="col-md-4 col-md-offset-4 col-xs-6 col-xs-offset-2 row">
				<p style="text-align: left!important">所在院系：xxxxxxxxxxxxxxxxxx</p>
			</div>
		</div>
	</div>
<!--div id="tab">	
...
<div id="myTabContent" class="tab-content">
	...
	<div class="container-fluid hfunction" style="padding-top: 1%;">
		<ul class="media-list col-md-8 col-md-offset-2 col-xs-10 col-sm-10 col-sm-offset-1" style="padding:0px;"><!--我的收藏-->
			...
			<div class="page" style="margin-top: 50px;font-color:#FF6347;">
	...
	<div class="container-fluid"><!--我的关注-->
		<div class="row media" style="margin-bottom: 10px; margin-top: 10px;">
			<div class="col-md-2 col-md-offset-1 col-xs-3 col-xs-offset-2" style="padding-left: 0px;">
				<img  src="./img/粉色竖条.png" style="height:20px;">
				<span id="word">近期访问</span>
			</div>
		</div>

		<div>
		<ul class="media-list col-md-8 col-md-offset-2 col-xs-10 col-sm-10 col-sm-offset-1 ">
			...
			<li class="media moments ">
				...
				<div class="media-body">
					...
					<button class="follow btn btn-default-xs" style="float: right;" >关注</button>					
					<div class="contents">							
						<div class="moments_content">这里是社团简介，这里是社团简介，这里是社团简介，这里是社团简介，这里是社团简介，这里是社团简介，这里是社团简介，这里是社团简介，这里是社团简介，</div>					
					</div> 	
			...
			<div class="row " style="margin-bottom: 10px;margin-top: 10px;">
				<div class="col-md-2 col-xs-3 col-xs-offset-1 col-md-offset-1" style="padding-left: 0px;">
					<img  src="./img/粉色竖条.png" style="height:20px;">
					<span id="word">全部关注</span>
				</div>
			</div>
			<li class="media moments ">
				<a class="media-left">
...
<div class="tab-pane fade" id="message">
	<div class="container-fluid" style="padding-top: 1%"><!--我的消息-->
		...
		<div class="col-md-2 col-xs-1">
			<ul id="myTab1" class="nav nav-tabs">
				<li class="active inter on" data-toggle="tab">
					<div class="row icon3 " >
						<a href="#personalmessage"><img src="./img/信封圆浅粉.png" width=20%;></a>
					</div>
				</li>
				<li class="inter off" data-toggle="tab">
					<div class="row icon3" >
						<a href="#personalat"><img src="./img/@圆深粉.png" width=20%;></a>
					</div>
				</li>
			</ul>
		</div>
	...
	<div id="myTabContent1" class="tab-content">
		<div class="tab-pane fade in active" id="personalmessage">
		<!--我的私信-->	
		<ul class="media-list col-md-8  col-xs-10 col-sm-10 " style="padding:0px;">
			...
			<li class="moments media">
				...
				<div class="media-body">
					...
					<div>
						<span class="at2 pull-left">回复的主题 ：</span>
						<a href=""><u class="at2" >"inankai产品发布会。   ‘掌’握我南开"</u></a>
					</div>
		...
		<div class="tab-pane fade" id="personalat">
			<ul class="media-list col-md-8  col-xs-10 col-sm-10 " style="padding:0px;">
			<!--<div id="commu" class="moments media">-->
			<li class="moments media">
				<a class="media-left" href="">
				...
				<div class="media-body">
					<div class="media-heading">			
						<span id="name11" class=" pull-left" >大野智 : </span>
						<span class="at pull-left">@</span>
						<span id="name22" class="at pull-left" style="margin-right: 2px;">二宫和也</span>
						<span class="pull-left">nino今天来聚餐吗？我请。</span>
					</div>	
					<br/>
					<div>
...
<div class="tab-pane fade" id="schedule"><!--我的日程-->
<div class="container-fluid">
	<div class="col-md-8 col-md-offset-2">		

		<div class="row pull-left" style="margin-top: 2%;">
			<img  src="./img/粉色竖条.png" style="height:20px;"><a href="">本月日程</a>
		</div>

		<ul class="timeline">
			<li>
				<div class="time">2017/09/13 星期五</div>
				<!--<div class="version">v6.1.0</div>-->
				
				<div class="number"></div>
				<div class="content" style="margin-left: 160px; padding-top: 2%;">
					<div style="text-align: left;">
						<div class="pull-left">
							<span>9:00-11:30</span>
							
							<img src="./img/粉色竖条.png" style="height:20px;">
							<span>inankai新品发布会,"掌"握我南开</span>
							<img src="./img/减号.png"   class="pull-right" style="height:15px;">
						</div>
						<div class="row"></div>	
						<div class="row pull-left" style="margin-left: 74px;">
							<img src="./img/粉色竖条.png" style="height:20px;">
							<img src="./img/地点图标.png" style="width:12px;" >
							<span id="sitew" class="sitestyle">八里台校区东方艺术</span>
						</div>
			...
			<div class="row pull-left" style="margin-top: 2%;">
				<img  src="./img/粉色竖条.png" style="height:20px;"><a href="">1月日程</a>
			</div>
			<div class="row"></div>
			<ul class="timeline">
				<li>
...
<script type="text/javascript">
    ...
    $("#site").css("height",$("#sitew").outerHeight());
    });
